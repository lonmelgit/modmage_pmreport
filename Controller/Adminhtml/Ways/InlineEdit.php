...
use ModMage\PmReport\Api\WaysRepositoryInterface as WaysRepository;
...
class InlineEdit extends \Magento\Backend\App\Action
{
        ...
        foreach (array_keys($postItems) as $waysId) {
            ...
            try {
                ...
                $messages[] = $this->getErrorWithWaysId(
                    $ways,
                    __('Something went wrong while saving the new payment history record.')
                );
                $error = true;
            }
        }
    ...
    public function setWaysData(\ModMage\PmReport\Model\Ways $ways, array $extendedWaysData, array $waysData)
    {
